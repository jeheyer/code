...
def main():
    ...
    try:
        ...
        config.read('/mnt/homes/j5/private/cfg/mysql.cfg')
        mysql_hostname = config['test']['hostname']
        mysql_username = config['test']['username']
        mysql_password = config['test']['password']
